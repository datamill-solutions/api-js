...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new datamill-js-client.SocialMediaActivitiesGetTwitter();
  });
  ...
  describe('SocialMediaActivitiesGetTwitter', function() {
    it('should create an instance of SocialMediaActivitiesGetTwitter', function() {
      // uncomment below and update the code to test SocialMediaActivitiesGetTwitter
      //var instane = new datamill-js-client.SocialMediaActivitiesGetTwitter();
      //expect(instance).to.be.a(datamill-js-client.SocialMediaActivitiesGetTwitter);
    });
