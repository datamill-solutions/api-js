...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new datamill-js-client.SocialMediaActivitiesGetInstagram();
  });
  ...
  describe('SocialMediaActivitiesGetInstagram', function() {
    it('should create an instance of SocialMediaActivitiesGetInstagram', function() {
      // uncomment below and update the code to test SocialMediaActivitiesGetInstagram
      //var instane = new datamill-js-client.SocialMediaActivitiesGetInstagram();
      //expect(instance).to.be.a(datamill-js-client.SocialMediaActivitiesGetInstagram);
    });
    ...
    it('should have the property engagementPercent (base name: "engagement_percent")', function() {
      // uncomment below and update the code to test the property engagementPercent
      //var instane = new datamill-js-client.SocialMediaActivitiesGetInstagram();
      //expect(instance).to.be();
    });
