...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new datamill-js-client.BusinessDataDunsResolveResponse();
  });
  ...
  describe('BusinessDataDunsResolveResponse', function() {
    it('should create an instance of BusinessDataDunsResolveResponse', function() {
      ...
      //var instane = new datamill-js-client.BusinessDataDunsResolveResponse();
      //expect(instance).to.be.a(datamill-js-client.BusinessDataDunsResolveResponse);
    });
