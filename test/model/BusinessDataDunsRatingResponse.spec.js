...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new datamill-js-client.BusinessDataDunsRatingResponse();
  });
  ...
  describe('BusinessDataDunsRatingResponse', function() {
    it('should create an instance of BusinessDataDunsRatingResponse', function() {
      ...
      //var instane = new datamill-js-client.BusinessDataDunsRatingResponse();
      //expect(instance).to.be.a(datamill-js-client.BusinessDataDunsRatingResponse);
    });
