...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.BusinessDataUndeliverableContactsSearchContact = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @module model/BusinessDataUndeliverableContactsSearchContact
   * @version 1.6.4
   */
   ...
   * @alias module:model/BusinessDataUndeliverableContactsSearchContact
   * @class
   */
   ...
   * @param {module:model/BusinessDataUndeliverableContactsSearchContact} obj Optional instance to populate.
   * @return {module:model/BusinessDataUndeliverableContactsSearchContact} The populated <code>BusinessDataUndeliverableContactsSearchContact</code> instance.
   */
   ...
   * @member {module:model/BusinessDataUndeliverableContactsSearchContact.GenderEnum} gender
   */
