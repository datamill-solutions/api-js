...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.ErrorNotAllowed = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @alias module:model/ErrorNotAllowed
   * @class
   ...
   * @param {module:model/ErrorNotAllowed} obj Optional instance to populate.
   * @return {module:model/ErrorNotAllowed} The populated <code>ErrorNotAllowed</code> instance.
   */
