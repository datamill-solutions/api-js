...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.BusinessDataDunsSearchResult = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @module model/BusinessDataDunsSearchResult
   * @version 1.6.4
   */
   ...
   * @alias module:model/BusinessDataDunsSearchResult
   * @class
   */
   ...
   * @param {module:model/BusinessDataDunsSearchResult} obj Optional instance to populate.
   * @return {module:model/BusinessDataDunsSearchResult} The populated <code>BusinessDataDunsSearchResult</code> instance.
   */
   ...
   * @member {module:model/BusinessDataDunsSearchResult.BranchCodeEnum} branch_code
   */
  exports.prototype['branch_code'] = undefined;
  /**
   * Description of the company's branch
   * @member {module:model/BusinessDataDunsSearchResult.BranchDescriptionEnum} branch_description
   */
