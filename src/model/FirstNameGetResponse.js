...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.FirstNameGetResponse = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @module model/FirstNameGetResponse
   * @version 1.6.4
   */
   ...
   * @alias module:model/FirstNameGetResponse
   * @class
   ...
   * @param {module:model/FirstNameGetResponse} obj Optional instance to populate.
   * @return {module:model/FirstNameGetResponse} The populated <code>FirstNameGetResponse</code> instance.
   */
