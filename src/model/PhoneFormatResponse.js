...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.PhoneFormatResponse = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @module model/PhoneFormatResponse
   * @version 1.6.4
   */
   ...
   * @alias module:model/PhoneFormatResponse
   * @class
   ...
   * @param {module:model/PhoneFormatResponse} obj Optional instance to populate.
   * @return {module:model/PhoneFormatResponse} The populated <code>PhoneFormatResponse</code> instance.
   */
   ...
   * @member {module:model/PhoneFormatResponse.TypeEnum} type
   */
