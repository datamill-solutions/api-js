...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.BusinessDataDunsResolveResponse = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @module model/BusinessDataDunsResolveResponse
   * @version 1.6.4
   */
   ...
   * @alias module:model/BusinessDataDunsResolveResponse
   * @class
   * @param status {module:model/BusinessDataDunsResolveResponse.StatusEnum} Flag if a company was found by its D-U-N-S number or not [**0*, **1**]
   * @param statusDescription {module:model/BusinessDataDunsResolveResponse.StatusDescriptionEnum} Describes if a company was found or if the specified D-U-N-S number could not be resolved. Possible values are: **company not found**, **company found**, **invalid duns number** 
   */
   ...
   * @param {module:model/BusinessDataDunsResolveResponse} obj Optional instance to populate.
   * @return {module:model/BusinessDataDunsResolveResponse} The populated <code>BusinessDataDunsResolveResponse</code> instance.
   */
   ...
   * @member {module:model/BusinessDataDunsResolveResponse.StatusEnum} status
   */
   ...
   * @member {module:model/BusinessDataDunsResolveResponse.StatusDescriptionEnum} status_description
   */
   ...
   * @member {module:model/BusinessDataDunsResolveResponse.AnnualTurnoverIndicatorCodeEnum} annual_turnover_indicator_code
   */
   ...
   * @member {module:model/BusinessDataDunsResolveResponse.MarketabilityCodeEnum} marketability_code
   */
   ...
   * @member {module:model/BusinessDataDunsResolveResponse.TotalEmployeesIndicatorEnum} total_employees_indicator
   */
   ...
   * @member {module:model/BusinessDataDunsResolveResponse.TotalEmployeesPhysicalAddressIndicatorEnum} total_employees_physical_address_indicator
   */
   ...
   * @member {module:model/BusinessDataDunsResolveResponse.ImportExportIndicatorEnum} import_export_indicator
   */
   ...
   * @member {module:model/BusinessDataDunsResolveResponse.BusinessStructureCodeEnum} business_structure_code
   */
   ...
   * @member {module:model/BusinessDataDunsResolveResponse.UndeliverableIndicatorEnum} undeliverable_indicator
   */
