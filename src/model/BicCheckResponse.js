...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.BicCheckResponse = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @alias module:model/BicCheckResponse
   * @class
   * @param valid {module:model/BicCheckResponse.ValidEnum} Flag if the spelling of the BIC/SWIFT code is valid or not [**0**, **1**] 
   ...
   * @param {module:model/BicCheckResponse} obj Optional instance to populate.
   * @return {module:model/BicCheckResponse} The populated <code>BicCheckResponse</code> instance.
   */
   ...
   * @member {module:model/BicCheckResponse.ValidEnum} valid
   */
