...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BusinessDataUndeliverableContactsSearchContact'], factory);
    ...
    root.DatamillForApplications.BusinessDataUndeliverableContactsResponse = factory(root.DatamillForApplications.ApiClient, root.DatamillForApplications.BusinessDataUndeliverableContactsSearchContact);
  }
   ...
   * @module model/BusinessDataUndeliverableContactsResponse
   * @version 1.6.4
   */
   ...
   * @alias module:model/BusinessDataUndeliverableContactsResponse
   * @class
   * @param undeliverable {module:model/BusinessDataUndeliverableContactsResponse.UndeliverableEnum} Flag if sending a mail would result in an undeliverable state [**0**, **1**]
   * @param deceased {module:model/BusinessDataUndeliverableContactsResponse.DeceasedEnum} Flag if the person is deceased [**0**, **1**]
   * @param moved {module:model/BusinessDataUndeliverableContactsResponse.MovedEnum} Flag if the person has moved to a new address but we do not know the new address [**0**, **1**]
   * @param newAddressAvailable {module:model/BusinessDataUndeliverableContactsResponse.NewAddressAvailableEnum} Flag if the person has moved to a new address and we know the new address [**0**, **1**]
   * @param contact {module:model/BusinessDataUndeliverableContactsSearchContact} 
   */
   ...
   * @param {module:model/BusinessDataUndeliverableContactsResponse} obj Optional instance to populate.
   * @return {module:model/BusinessDataUndeliverableContactsResponse} The populated <code>BusinessDataUndeliverableContactsResponse</code> instance.
   */
   ...
   * @member {module:model/BusinessDataUndeliverableContactsResponse.UndeliverableEnum} undeliverable
   */
  exports.prototype['undeliverable'] = undefined;
  /**
   * Flag if the person is deceased [**0**, **1**]
   * @member {module:model/BusinessDataUndeliverableContactsResponse.DeceasedEnum} deceased
   */
  exports.prototype['deceased'] = undefined;
  /**
   * Flag if the person has moved to a new address but we do not know the new address [**0**, **1**]
   * @member {module:model/BusinessDataUndeliverableContactsResponse.MovedEnum} moved
   */
  exports.prototype['moved'] = undefined;
  /**
   * Flag if the person has moved to a new address and we know the new address [**0**, **1**]
   * @member {module:model/BusinessDataUndeliverableContactsResponse.NewAddressAvailableEnum} new_address_available
   */
  exports.prototype['new_address_available'] = undefined;
  /**
   * @member {module:model/BusinessDataUndeliverableContactsSearchContact} contact
   */
