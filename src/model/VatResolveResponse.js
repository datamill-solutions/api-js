...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.VatResolveResponse = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @module model/VatResolveResponse
   * @version 1.6.4
   */
   ...
   * @alias module:model/VatResolveResponse
   * @class
   ...
   * @param {module:model/VatResolveResponse} obj Optional instance to populate.
   * @return {module:model/VatResolveResponse} The populated <code>VatResolveResponse</code> instance.
   */
