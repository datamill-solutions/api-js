...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.ErrorMissingParameters = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @module model/ErrorMissingParameters
   * @version 1.6.4
   */
   ...
   * @alias module:model/ErrorMissingParameters
   * @class
   ...
   * @param {module:model/ErrorMissingParameters} obj Optional instance to populate.
   * @return {module:model/ErrorMissingParameters} The populated <code>ErrorMissingParameters</code> instance.
   */
