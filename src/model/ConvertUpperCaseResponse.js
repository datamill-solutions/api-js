...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.ConvertUpperCaseResponse = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @module model/ConvertUpperCaseResponse
   * @version 1.6.4
   */
   ...
   * @alias module:model/ConvertUpperCaseResponse
   * @class
   ...
   * @param {module:model/ConvertUpperCaseResponse} obj Optional instance to populate.
   * @return {module:model/ConvertUpperCaseResponse} The populated <code>ConvertUpperCaseResponse</code> instance.
   */
