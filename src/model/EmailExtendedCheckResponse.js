...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.DatamillForApplications.EmailExtendedCheckResponse = factory(root.DatamillForApplications.ApiClient);
  }
   ...
   * @module model/EmailExtendedCheckResponse
   * @version 1.6.4
   */
   ...
   * @param {module:model/EmailExtendedCheckResponse} obj Optional instance to populate.
   * @return {module:model/EmailExtendedCheckResponse} The populated <code>EmailExtendedCheckResponse</code> instance.
   */
   ...
   * @member {module:model/EmailExtendedCheckResponse.ValidEnum} valid
   */
   ...
   * @member {module:model/EmailExtendedCheckResponse.DescriptionEnum} description
   */
  exports.prototype['description'] = undefined;
  /**
   * Unique status code for each possible validation state.  * **1**: The email address has a valid syntax, a MX record exists, it's not disposable and the mailbox exists.  * **10**: Typo error in email address  * **20**: No MX record found for domain part  * **21**: Known provider for disposable email addresses  * **30**: The mail server rejects emails for the given mailbox  * **31**: Connection to mail server could not be established  * **32**: The request was blocked by the mail server (greylisted)  * **33**: The mail server accepts mails for all email addresses 
   * @member {module:model/EmailExtendedCheckResponse.StatusCodeEnum} status_code
   */
