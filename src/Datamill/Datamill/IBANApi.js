...
(function(root, factory) {
   ...
   * @alias module:Datamill/Datamill/IBANApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:Datamill/Datamill/IBANApi~checkIBANCallback
