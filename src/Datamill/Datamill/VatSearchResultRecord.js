...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.datamill-js-client.VatSearchResultRecord = factory(root.datamill-js-client.ApiClient);
  }
   ...
   * @module Datamill/Datamill/VatSearchResultRecord
   * @version 0.0.1
   */
   ...
   * @alias module:Datamill/Datamill/VatSearchResultRecord
   * @class
   ...
   * @param {module:Datamill/Datamill/VatSearchResultRecord} obj Optional instance to populate.
   * @return {module:Datamill/Datamill/VatSearchResultRecord} The populated <code>VatSearchResultRecord</code> instance.
   */
