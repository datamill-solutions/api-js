...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BusinessDataUndeliverableContactsResponse', 'model/ErrorForbidden', 'model/ErrorIncorrectParameters', 'model/ErrorInternalError', 'model/ErrorMissingParameters', 'model/ErrorNotAllowed', 'model/ErrorNotFound', 'model/ErrorQuotaExceeded', 'model/ErrorServiceUnavailable', 'model/ErrorUnauthorized'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BusinessDataUndeliverableContactsResponse'), require('../model/ErrorForbidden'), require('../model/ErrorIncorrectParameters'), require('../model/ErrorInternalError'), require('../model/ErrorMissingParameters'), require('../model/ErrorNotAllowed'), require('../model/ErrorNotFound'), require('../model/ErrorQuotaExceeded'), require('../model/ErrorServiceUnavailable'), require('../model/ErrorUnauthorized'));
  } else {
    // Browser globals (root is window)
    if (!root.DatamillForApplications) {
      root.DatamillForApplications = {};
    }
    root.DatamillForApplications.DeliveryInformationApi = factory(root.DatamillForApplications.ApiClient, root.DatamillForApplications.BusinessDataUndeliverableContactsResponse, root.DatamillForApplications.ErrorForbidden, root.DatamillForApplications.ErrorIncorrectParameters, root.DatamillForApplications.ErrorInternalError, root.DatamillForApplications.ErrorMissingParameters, root.DatamillForApplications.ErrorNotAllowed, root.DatamillForApplications.ErrorNotFound, root.DatamillForApplications.ErrorQuotaExceeded, root.DatamillForApplications.ErrorServiceUnavailable, root.DatamillForApplications.ErrorUnauthorized);
  }
   ...
   * @module api/DeliveryInformationApi
   * @version 1.6.4
   */

  /**
   * Constructs a new DeliveryInformationApi. 
   * @alias module:api/DeliveryInformationApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/DeliveryInformationApi~searchUndeliverableContactCallback
     * @param {String} error Error message, if any.
     * @param {module:model/BusinessDataUndeliverableContactsResponse} data The data returned by the service call.
     ...
     * @param {module:api/DeliveryInformationApi~searchUndeliverableContactCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/BusinessDataUndeliverableContactsResponse}
     */
