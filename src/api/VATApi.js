...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ErrorForbidden', 'model/ErrorIncorrectParameters', 'model/ErrorInternalError', 'model/ErrorMissingParameters', 'model/ErrorNotAllowed', 'model/ErrorNotFound', 'model/ErrorQuotaExceeded', 'model/ErrorServiceUnavailable', 'model/ErrorUnauthorized', 'model/VatCheckResponse', 'model/VatResolveResponse', 'model/VatSearchResponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ErrorForbidden'), require('../model/ErrorIncorrectParameters'), require('../model/ErrorInternalError'), require('../model/ErrorMissingParameters'), require('../model/ErrorNotAllowed'), require('../model/ErrorNotFound'), require('../model/ErrorQuotaExceeded'), require('../model/ErrorServiceUnavailable'), require('../model/ErrorUnauthorized'), require('../model/VatCheckResponse'), require('../model/VatResolveResponse'), require('../model/VatSearchResponse'));
  } else {
    // Browser globals (root is window)
    if (!root.DatamillForApplications) {
      root.DatamillForApplications = {};
    }
    root.DatamillForApplications.VATApi = factory(root.DatamillForApplications.ApiClient, root.DatamillForApplications.ErrorForbidden, root.DatamillForApplications.ErrorIncorrectParameters, root.DatamillForApplications.ErrorInternalError, root.DatamillForApplications.ErrorMissingParameters, root.DatamillForApplications.ErrorNotAllowed, root.DatamillForApplications.ErrorNotFound, root.DatamillForApplications.ErrorQuotaExceeded, root.DatamillForApplications.ErrorServiceUnavailable, root.DatamillForApplications.ErrorUnauthorized, root.DatamillForApplications.VatCheckResponse, root.DatamillForApplications.VatResolveResponse, root.DatamillForApplications.VatSearchResponse);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/VATApi~checkVATCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VatCheckResponse} data The data returned by the service call.
     ...
     * @param {module:api/VATApi~checkVATCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VatCheckResponse}
     */
     ...
     * @callback module:api/VATApi~resolveVATCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VatResolveResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/VATApi~resolveVATCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VatResolveResponse}
     */
     ...
     * @callback module:api/VATApi~searchVATCallback
     * @param {String} error Error message, if any.
     * @param {module:model/VatSearchResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/String} opts.countryCode ISO 3166-1 alpha-2 country code to specify in which country to look for. Possible countries are: **AT, BE, CZ, DK, FI, GB, GR, HU, IT, LU, MT, SI** 
     ...
     * @param {module:api/VATApi~searchVATCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/VatSearchResponse}
     */
