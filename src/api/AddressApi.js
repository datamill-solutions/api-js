...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AddressHouseNumberExtractResponse', 'model/AddressSearchMultipleResponse', 'model/AddressSearchResponse', 'model/ErrorForbidden', 'model/ErrorIncorrectParameters', 'model/ErrorInternalError', 'model/ErrorMissingParameters', 'model/ErrorNotAllowed', 'model/ErrorNotFound', 'model/ErrorQuotaExceeded', 'model/ErrorServiceUnavailable', 'model/ErrorUnauthorized'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AddressHouseNumberExtractResponse'), require('../model/AddressSearchMultipleResponse'), require('../model/AddressSearchResponse'), require('../model/ErrorForbidden'), require('../model/ErrorIncorrectParameters'), require('../model/ErrorInternalError'), require('../model/ErrorMissingParameters'), require('../model/ErrorNotAllowed'), require('../model/ErrorNotFound'), require('../model/ErrorQuotaExceeded'), require('../model/ErrorServiceUnavailable'), require('../model/ErrorUnauthorized'));
  } else {
    // Browser globals (root is window)
    if (!root.DatamillForApplications) {
      root.DatamillForApplications = {};
    }
    root.DatamillForApplications.AddressApi = factory(root.DatamillForApplications.ApiClient, root.DatamillForApplications.AddressHouseNumberExtractResponse, root.DatamillForApplications.AddressSearchMultipleResponse, root.DatamillForApplications.AddressSearchResponse, root.DatamillForApplications.ErrorForbidden, root.DatamillForApplications.ErrorIncorrectParameters, root.DatamillForApplications.ErrorInternalError, root.DatamillForApplications.ErrorMissingParameters, root.DatamillForApplications.ErrorNotAllowed, root.DatamillForApplications.ErrorNotFound, root.DatamillForApplications.ErrorQuotaExceeded, root.DatamillForApplications.ErrorServiceUnavailable, root.DatamillForApplications.ErrorUnauthorized);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/AddressApi~extractHouseNumberCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AddressHouseNumberExtractResponse} data The data returned by the service call.
     ...
     * @param {module:api/AddressApi~extractHouseNumberCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AddressHouseNumberExtractResponse}
     */
     ...
     * @callback module:api/AddressApi~locateAddressCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AddressSearchResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/AddressApi~locateAddressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AddressSearchResponse}
     */
     ...
     * @callback module:api/AddressApi~searchAddressCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AddressSearchResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {String} opts.locale The preferred language of address elements in the result. The locale must be provided according to RFC 4647 standard (language code).
     * @param {module:api/AddressApi~searchAddressCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AddressSearchResponse}
     */
     ...
     * @callback module:api/AddressApi~searchAddressMultipleCallback
     * @param {String} error Error message, if any.
     * @param {module:model/AddressSearchMultipleResponse} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.locale The preferred language of address elements in the result. The locale must be provided according to RFC 4647 standard (language code).
     * @param {module:api/AddressApi~searchAddressMultipleCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/AddressSearchMultipleResponse}
     */
